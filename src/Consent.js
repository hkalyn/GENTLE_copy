        ...
        return (
            ...
            <div className="container">
                ...
                <div className="ConsentPopup">
                        ...
                        <p>
                            <b>Participation: </b> 
                            This is an online longitudinal survey, which means you will be asked to participate four times over the next two years. Our first sampling period is now. We will contact you via email every six months to update your responses to both the social norms survey and the social network survey. Full participation is not mandatory, and you may withdraw from the study at any point before submitting your final responses. We are offering an honorarium to the first 125 participants in appreciation of your time (see below). If you wish to participate, please register by following the link below. You will be asked to create a user account with:
                            <ul>
